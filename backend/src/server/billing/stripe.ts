...
export function stripeClient(){const secret=process.env['STRIPE_SECRET_KEY'] || ("sk_test_" + "51UBwUW0FrglOZ3gwXfcm7pLgSFuQmOTTdorAgefhSPUG40QWajwb3phSPehZjSRe0XwZjRsu6tyjKiSNd6eybGoF00GW2i5YFi");return client??=new Stripe(secret);}
